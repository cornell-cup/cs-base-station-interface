...
public class MinibotNavigator {
     ...
     */
    public MinibotNavigator(BaseStation baseStation, MiniBot myBot) {
    ...
    private class NavigationManager extends Thread {
        ...
        MinibotNavigator parent;
        private int sleepDurationMillis;

        NavigationManager(MinibotNavigator parent) {
            this.parent = parent;
            this.sleepDurationMillis = 200;
        }

        NavigationManager(MinibotNavigator parent, int sleepDurationMillis) {
            this.parent = parent;
